// ملف إصلاح قاعدة البيانات المباشر - شفا كير
...
async function fixDatabaseDirect() {
  console.log('🔧 جاري إصلاح قاعدة البيانات مباشرة...\n');

  try {
    // 1. محاولة إدراج بيانات المرضى مع قيم إنجليزية أولاً
    console.log('🏥 محاولة إدراج بيانات المرضى...');
    const patientsData = [
      { name: 'أحمد محمد', email: 'ahmed.mohamed@example.com', phone: '+201234567890', date_of_birth: '1990-05-15', gender: 'male', addiction_type: 'drugs', admission_date: '2024-01-15', status: 'active' },
      { name: 'فاطمة علي', email: 'fatima.ali@example.com', phone: '+201234567891', date_of_birth: '1985-08-22', gender: 'female', addiction_type: 'alcohol', admission_date: '2024-02-01', status: 'active' },
      { name: 'محمد عبدالله', email: 'mohamed.abdullah@example.com', phone: '+201234567892', date_of_birth: '1988-12-10', gender: 'male', addiction_type: 'smoking', admission_date: '2024-01-20', status: 'active' },
      { name: 'سارة أحمد', email: 'sara.ahmed@example.com', phone: '+201234567893', date_of_birth: '1992-03-08', gender: 'female', addiction_type: 'drugs', admission_date: '2024-02-15', status: 'active' },
      { name: 'علي حسن', email: 'ali.hassan@example.com', phone: '+201234567894', date_of_birth: '1987-07-12', gender: 'male', addiction_type: 'alcohol', admission_date: '2024-01-25', status: 'active' }
    ];
    ...
    // 2. محاولة إدراج بيانات الغرف
    console.log('\n🏠 محاولة إدراج بيانات الغرف...');
    const roomsData = [
    ...
    // 3. محاولة إدراج بيانات الأسرّة
    console.log('\n🛏️ محاولة إدراج بيانات الأسرّة...');
    ...
    // 4. محاولة إدراج بيانات مصاريف المصحة
    console.log('\n💰 محاولة إدراج بيانات مصاريف المصحة...');
    const expensesData = [
    ...
    // 5. محاولة إدراج بيانات الجلسات
    console.log('\n📅 محاولة إدراج بيانات الجلسات...');
    ...
    console.log('\n🎉 تم الانتهاء من محاولة إصلاح قاعدة البيانات!');
